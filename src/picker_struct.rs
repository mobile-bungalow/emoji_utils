...
/// struct which represents an emoji and its descriptive tags
pub struct EmojiData {
    pub emoji: &'static str,
    pub tags: &'static [&'static str],
}

/// section start index for smileys and emoticons
pub static SMILEYS_EMOTION: usize = 0;
/// section start index for people & body parts
pub static PEOPLE_BODY: usize = 149;
/// section start index for animals and nature
pub static ANIMALS_NATURE: usize = 483;
/// section start index for food and drinks
pub static FOOD_DRINK: usize = 610;
/// section start index for travel and places
pub static TRAVEL_PLACES: usize = 731;
/// section start index for activities
pub static ACTIVITIES: usize = 941;
/// section start index for objects
pub static OBJECTS: usize = 1020;
/// section start index for symbols
pub static SYMBOLS: usize = 1253;
/// section start index for flags
pub static FLAGS: usize = 1470;

/// all current apple supported emojis in a static array,
/// with their accompanying descriptive tags.
